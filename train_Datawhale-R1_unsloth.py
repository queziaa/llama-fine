...
def main():
    """主函数，用于执行主训练循环"""
    # 解析命令行参数和配置文件
    parser = TrlParser((ModelConfig, GRPOConfig, SwanlabArguments))
    model_args, training_args, swanlab_args = (
    ...
    # 运行主训练循环
    grpo_function(model_args, training_args, callbacks=callbacks)
